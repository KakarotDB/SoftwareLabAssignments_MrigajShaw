...
\usepackage[T1]{fontenc} % Critical for modern fonts in pdflatex
\usepackage{geometry}
\usepackage{fancyhdr}
\usepackage{listings}
\usepackage{xcolor}
...
% --- FONTS (The Package Method) ---
% MiKTeX will ask to install these automatically when you run it.
\usepackage[sfdefault]{inter} % Sets Inter as the main text font
\usepackage[scale=0.85]{roboto-mono} % Sets Roboto Mono as code font
...
\lstdefinestyle{MyCodeStyle}{
    ...
    basicstyle=\ttfamily\footnotesize, % This will now use Roboto Mono
