...
namespace EmployeeInformationSystem {
	...
	class Employee : virtual public Person {
		...
		public:
			Employee(std::string name = "N/A", int age = 0, std::string gender = "N/A", int employee_ID = -1, double salary = 0): Person(name, age, gender), m_employee_ID(employee_ID), m_salary(salary) {}
	...
	class Specialist : virtual public Person {
		...
		public:
			Specialist(std::string name = "N/A", int age = 0, std::string gender = "N/A", std::string department = "N/A", std::string skillset = "N/A") : Person(name, age, gender), m_department(department), m_skillset(skillset) {}
	...
	class Developer : public Employee, public Specialist {
		...
		public: 
			Developer(std::string name = "N/A", int age = 0, std::string gender = "N/A", int employee_ID = -1, double salary = 0, std::string department = "N/A", std::string skillset = "N/A", std::string project = "N/A", int Years_Of_Experience = 0): Person(name, age, gender), Employee(name, age, gender, employee_ID, salary), Specialist(name, age, gender, department, skillset), m_project(project), m_Years_Of_Experience(Years_Of_Experience) {}
			...
			void display() const override {
				...
				std::cout << "Project: " << m_project << std::endl
						  << "Years of Experience: " << m_Years_Of_Experience << std::endl;
			}
	};
}
